  ...
  return (
    <div className='header'>
        ...
        <Navbar collapseOnSelect expand="lg" style={{ backgroundColor : '#dceff0'}}>
            <Container>
                <Navbar.Brand>
                <Link className='nav-link' to={"/stylistpages/StylistHome"} > 
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Link className='nav_link' to={"/stylistpages/StylistHome"} > Home </Link>
                    <Link className='nav_link' to={"/stylistpages/ListStylists"}> Stylists </Link>
                    <Link className='nav_link' to={"/stylistpages/StylistBooking"}> Booking </Link>
                    <Link className='nav_link' to={"/stylistpages/StylistAbout"}> About </Link>
                    <Link className='nav_link' to={"/stylistpages/StylistContact"}> Contact Us </Link>
