            ...
            <Row>
                ...
                <Col sm>
                    <div>
                        ...
                        <div>
                            <p style={{ paddingBottom: '5px'}}>Sign Up with us to get all latest updates and offers offered in our parlour.</p>
                            <button className='btn ' style={{ backgroundColor: '#d81b60', color: '#f2f2f2', width: '100px', padding: '5px'}}> Sign Up</button>
                        </div>
