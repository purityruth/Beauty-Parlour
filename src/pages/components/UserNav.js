        ...
        <Navbar collapseOnSelect expand="lg" style={{ backgroundColor : '#dceff0'}}>
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Link className='nav-link' to={"/components/Services"}> Services </Link>
                    <Link className='nav-link' to={"/components/Gallery"}> Gallery </Link>
                    <Link className='nav-link' to={"/components/Stylists"}> Stylists </Link>
                    <Link className='nav-link' to={"/components/Contact"}> Contact Us </Link>
                    ...
                    <Nav>
                    <Link className='nav-link' to={"/admincustomer/LoginCustomer"}>Logout </Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
