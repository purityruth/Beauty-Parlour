        ...
        <div className="content-wrapper">
            ...
            <div className="container-fluid">
                ...
                <div className="col-lg-3 col-6">
                    {/* small box */}
                    <div className="small-box" style={{backgroundColor: '#f327af'}}>
                    <div className="inner">
                        <h3>15</h3>
                        <p>Services</p>
                    </div>
                    <div className="icon">
                        ...
                        <Link className='nav-link small-box-footer' to={"/services/ListService"}>
                        More info 
                ...
                <div className="col-lg-3 col-6">
                    {/* small box */}
                    <div className="small-box" style={{backgroundColor: '#d2f314'}}>
                    <div className="inner">
                    ...
                    <div className="icon">
                        ...
                        <Link className='nav-link small-box-footer' to={"/adminstaff/ListStaff"}>
                        More info 
                        <i className="fas fa-arrow-circle-right" />
                        </Link>
                    </div>
                ...
                <div className="col-lg-3 col-6">
                    {/* small box */}
                    <div className="small-box" style={{backgroundColor: '#c00bf7'}}>
                    <div className="inner">
                        <h3>44</h3>
                        <p>Customers</p>
                    </div>
                    ...
                    <Link className='nav-link small-box-footer' to={"/admincustomer/ListCustomer"}>
                    More info 
                    <i className="fas fa-arrow-circle-right" />
                    </Link>
                    </div>
                ...
                <div className="col-lg-3 col-6">
                    {/* small box */}
                    <div className="small-box" style={{backgroundColor: '#14f3ce'}}>
                    <div className="inner">
                        <h3>65</h3>
                        <p>Appointments</p>
                    </div>
                    <div className="icon">
                        ...
                        <Link className='nav-link small-box-footer' to={"/appointments/ListAppointment"}>
                        More info 
                        <i className="fas fa-arrow-circle-right" />
                        </Link>
                    </div>
                ...
                <section className="col-lg-7 connectedSortable">
                    ...
                    <div className="card-header">
                        ...
                        <ul className="nav nav-pills ml-auto">
                            ...
                            <a className="nav-link active" href="#revenue-chart" data-toggle="tab">Membership</a>
                            </li>
                            <li className="nav-item">
                            <a className="nav-link" href="#sales-chart" data-toggle="tab">Work Progress</a>
                            </li>
                        </ul>
                        </div>
                    </div>{/* /.card-header */}
