...
export default function LoginAdmin() {
  ...
  const LoginAdmin = async (e) => {
    ...
    await axios.post(`http://localhost:8000/api/loginStaff`, formData).then(({data})=>{
      Swal.fire({
        icon:"success",
        text:data.message
      })
    ...
    navigate('/admincomponents/AdminLanding')
      ...
      <div className="content-header">
        <div className="container-fluid">
            ...
            <div className="col-sm-4">
                <h1 style={{ display: 'block', textAlign: 'center', color: '#7b1fa2', paddingTop: '20px'}} >Admin Login</h1>
            </div>{/* /.col */}
            <div className="col-sm-4">
