        ...
        <div className='container' style={{paddingTop: '150px'}}>
            ...
            <div className="row" style={{ paddingBottom: '0px'}}>
                ...
                <div className="section_title mb_20 text-center">
                    <h3 style={{ color: '#7b1fa2', fontWeight: 'bold', fontFamily: 'Lucida Sans Lucida Sans Regular Lucida Grande Lucida Sans Unicode Geneva Verdana sans-serif' }}>Our Experts</h3>
            ...
            <section className="content">
                <div className="row">
                    <div className="col-12">
                        <div className="card card-body" style={{backgroundColor: '#f3f3f3'}}>
                                            ...
                                            adminStaff.length > 0 && (
                                                adminStaff.map((row, key)=>(
                                                    <tr key={key} >
                                                        ...
                                                        <td style={{padding: '20px'}}>{row.phoneno}</td>
                ...
                <div className="container">
                    ...
                    <div className="col-md-4 col-sm-6">
                        <div className="single_gallery">
                            ...
                            <div className="img_overlay">
                                <h6 className="name fw_700 color_ff">Ms. Purity Ruth</h6>
                                ...
                                <div className="social_contact">
                                    <span><a href="https://mail.google.com/" title="E-Mail" target="_blank"><FontAwesomeIcon icon={faEnvelope} className='icon' /></a></span>
                                    <span><a href="#" title="Phone" target="_blank"><FontAwesomeIcon icon={faMessage} className='icon' /></a></span>
                                    <span><a href="https://www.facebook.com/" title="Facebook" target="_blank"><FontAwesomeIcon icon={faFacebook} className='icon' /></a></span>
                    ...
                    {/** Expert 3 **/}
                        ...
                        <div className="single_gallery">
                            ...
                            <div className="img_overlay">
                                <h6 className="name fw_700 color_ff">Ms.Jane Hilton</h6>
